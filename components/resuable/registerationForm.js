...
export default function RegistrationForm() {
          ...
          <div className="col-lg-12">
            <div className="content-wrap">
              ...
              <div className="content-right">
                <p className="title mb-30 text-center font-main-2">Sign Up</p>
  ...
  <fieldset>
    <label
      htmlFor="cv"
      className="block text-gray-500 mb-2 cursor-pointer"
    >
      Upload Your CV
    </label>
    <input
    ...
    />
    {errors.cv && (
      <span className="text-red-500">{errors.cv.message}</span>
    )}
  </fieldset>
</div>
